...
//TODO： 含有通配符路径解析 http://www.coderli.com/spring-wildpath-parse/ how to parse
/**
 * 一个位置路径产生1个或多个匹配资源
...
//		注意使用的还是DefaultResouceLoader这个类
...
//		TODO：Enumeration 这个类型有点儿意思，用处=？
	...
	/**
	 * 使用这个UrlResource获得Resource的某个实现类的实例
